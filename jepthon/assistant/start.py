    ...
    if event.sender_id == bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                                     ...
                                     [Button.url("المطـور 🔗", "https://t.me/H_M_Dr"), Button.inline(
        ...
        await tgbot.send_message(
            ...
            buttons=[
                ...
                [Button.url("تحتاج مسـاعدة ❓", "https://t.me/H_M_Dr")],
            ],
        )
...
async def help(event):
    ...
    if event.query.user_id is not bot.uid:
        await tgbot.send_message(
            ...
            buttons=[
                [Button.url("مطوري  📺", "https://t.me/H_M_Dr")],
                [Button.url("قناة السورس ❓", "https://t.me/aaaalqp")],
            ],
        )
...
async def settings(event):
    if event.sender_id == bot.uid:
        ...
        await event.answer("انت لا تستطيع استخدام البوت احصل على بوتك من @aaaalqp", alert=True)
